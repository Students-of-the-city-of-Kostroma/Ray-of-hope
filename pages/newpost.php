...
<div class="newpost-wrapper">
    <div class="container">
        <div class="newpost-window">
            ...
            <form id="newpost_form" enctype="multipart/ orm-data">
                <div class="listtypepost">
                    <div class="typepost_radio">
                        <input class="input_newpost" id="nuzhd_inpt" name="typepost" type="radio" value="2" checked>
                        <label for="nuzhd_inpt" class="listtypepost_item">Нужда</label>
                        <input class="input_newpost" id="meropr_inpt" name="typepost" type="radio" value="1">
                        <label for="meropr_inpt" class="listtypepost_item">Мероприятие</label>
                        <input class="input_newpost" id="sobit_inpt" name="typepost" type="radio" value="3">
                ...
                <div class="content-inputs">
                    <div class="contentnewpost">
                        ...
                        <div class="imagelist_newpost"></div>
                    </div>
                    ...
                    <div class="buttons-newpost">
                        <input multiple name="newpost_images" id="file" type="file" class="add-image">
                        <label for="file" class="add_photo_newpost">
                            <img src="/assets/img/load_image_new_post.png">
                        </label>
                        <button onsubmit="return false;" id="send-newpost" class="send-newpost">Отправить</button>
                    </div>
                </div>
            </form>
        </div>
